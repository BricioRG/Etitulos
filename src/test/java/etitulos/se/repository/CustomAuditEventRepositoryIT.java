package etitulos.se.repository;

import etitulos.se.EtitulosApp;
import etitulos.se.config.Constants;
import etitulos.se.config.audit.AuditEventConverter;
import etitulos.se.domain.PersistentAuditEvent;
...
import static etitulos.se.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
